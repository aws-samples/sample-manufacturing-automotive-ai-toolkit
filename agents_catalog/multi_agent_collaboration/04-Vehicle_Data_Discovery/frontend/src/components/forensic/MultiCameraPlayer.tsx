/**
 * MultiCameraPlayer - 6-Camera Video Player
 * 
 * Video player supporting multiple camera angles (front, rear, sides).
 * Allows switching between cameras and synchronized playback.
 */
"use client"
