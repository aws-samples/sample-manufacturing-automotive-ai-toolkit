/**
 * FilterPills - Scene Filter Toggle Buttons
 * 
 * Horizontal pill-style buttons for filtering scenes by category
 * (all, anomaly, critical, normal). Supports animated selection state.
 */
"use client"
