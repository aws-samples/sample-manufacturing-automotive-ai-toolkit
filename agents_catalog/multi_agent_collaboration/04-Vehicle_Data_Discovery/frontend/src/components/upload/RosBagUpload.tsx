/**
 * RosBagUpload - Data Upload Component
 * 
 * Drag-and-drop file upload for ROS bag files and other driving data formats.
 * Handles presigned URL generation and direct S3 upload.
 */
"use client"
...
// Data format definitions - moved outside component to avoid stale closures
...
export default function RosBagUpload() {
  ...
  const uploadToS3 = async (presignedData: { upload_url: string }, file: File) => {
    // Fix: Use regional S3 endpoint for CORS compatibility
    let uploadUrl = presignedData.upload_url
