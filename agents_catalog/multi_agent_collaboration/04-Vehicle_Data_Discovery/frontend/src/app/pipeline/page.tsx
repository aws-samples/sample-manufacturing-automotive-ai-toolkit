/**
 * Pipeline Page - Processing Status Dashboard
 * 
 * Displays the status of the 6-phase video processing pipeline
 * including Step Functions executions and phase progress.
 * 
 * @route /pipeline
 */
"use client"
