...
export default function ClientForensicContent({
  ...
  useEffect(() => {
    ...
    async function fetchSceneData() {
      try {
        console.log(`Client-side: Fetching scene data for ${sceneId}...`)
        ...
        console.log("Client-side: Scene data fetched successfully")
      } catch (err) {
        console.error("Client-side: Failed to fetch scene data:", err)
  ...
  console.log(" ClientForensicContent rendering with sceneData:");
  console.log("key_findings:", sceneData.scene_understanding?.key_findings, typeof sceneData.scene_understanding?.key_findings);
  console.log("behavioral_insights:", sceneData.scene_understanding?.behavioral_insights, typeof sceneData.scene_understanding?.behavioral_insights);
