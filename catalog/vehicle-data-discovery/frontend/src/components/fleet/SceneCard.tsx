/**
 * SceneCard - Scene Preview Card Component
 * 
 * Displays a driving scene with thumbnail, risk score, tags,
 * camera info, and navigation to forensic detail view.
 */
"use client"
...
interface CameraData {
  ...
  const getCameraData = () => {
    if (scene.cameras && scene.cameras.length > 0) {
      ...
      const uniqueCameras = scene.cameras.reduce((acc: CameraData[], cam) => {
