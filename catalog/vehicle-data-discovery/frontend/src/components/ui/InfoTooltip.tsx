/**
 * InfoTooltip - Contextual Help Tooltip
 * 
 * Hover-triggered tooltip displaying metric definitions and explanations.
 * Auto-positions based on available viewport space.
 */
"use client"
