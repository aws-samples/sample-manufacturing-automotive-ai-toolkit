...
1. Construct the payload using the absolute file paths
...
```
User: "Generate technical design for weather app using weather_app_brd.md and weather_app_srs.md"
→ Cline calls MCP tool supplying documents absolute file paths
→ MCP tool generates design
→ Cline detects JSON output with technical design content
→ Cline saves technical design to: weather-app/technical-design/weather_app_technical_design.md
→ Cline confirms: "Technical design saved to weather-app/technical-design/weather_app_technical_design.md"
```
